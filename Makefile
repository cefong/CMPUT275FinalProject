...
# Modification by Le Minh Dang to include latest library
#
...
# local downloaded library from project
ifndef LOCAL_LIB
LOCAL_LIB = ./lib
endif
...
# replace default finding cpp from Arduino.mk
ifndef LOCAL_CPP_SRCS
LOCAL_CPP_SRCS = $(shell find $(SRC_DIR) -name *.cpp)
endif

# Arduino Included Libraries
ifndef ARDUINO_LIBS
ARDUINO_LIBS = ChRt Adafruit_GFX MCUFRIEND_kbv TouchScreen EEPROM SPI $(INC_DIR)
endif

# User Installed Library Location
ifndef USER_LIB_PATH
USER_LIB_PATH = $(LOCAL_LIB)/
endif
